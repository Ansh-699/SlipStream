// ---------------------------------------------------------------------------
// Vendored from @slipstream/client (slipstream/client/src/accounts.ts).
//
// CANONICAL, tested decoders for the on-chain account formats. Copied into the
// frontend instead of imported from ../client because Next/Turbopack will not
// bundle modules from outside the project root. Keep in sync with the SDK.
// Do NOT re-derive byte offsets in hooks/components — import these decoders.
// ---------------------------------------------------------------------------
